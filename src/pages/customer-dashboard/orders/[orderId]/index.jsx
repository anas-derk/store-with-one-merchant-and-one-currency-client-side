                                        ...
                                        <tbody>
                                            {orderDetails.products.map((orderProduct) => (
                                                <tr key={orderProduct._id}>
                                                    ...
                                                    <td>
                                                        {orderProduct.unitPrice.toFixed(2)} {t(process.env.currencyName)}
                                                    </td>
                                                    <td>
                                                        {orderProduct.totalAmount.toFixed(2)} {t(currencyName)}
                                                    </td>
                                                    <td>
                                                        <img
                                            ...
                                            <div className="order-product-box" key={orderProduct._id}>
                                                ...
                                                <table className="order-data-table customer-table mb-5 w-100">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>{t("Unit Price")}</th>
                                                            <td>{orderProduct.unitPrice.toFixed(2)} {t(currencyName)}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{t("Total")}</th>
                                                            <td>{orderProduct.totalAmount.toFixed(2)} {t(currencyName)}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{t("Image")}</th>
                                                            <td>
