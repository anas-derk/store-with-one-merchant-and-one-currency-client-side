        ...
        <div className="product-card card-box">
            ...
            {isDisplayProduct && <>
                ...
                <div className="product-details details-box p-3 text-center">
                    ...
                    <h5 className={`product-price ${(productDetails.discount !== 0 || productDetails.discountInOfferPeriod !== 0) ? "text-decoration-line-through" : ""}`}>{productDetails.price.toFixed(2)} {t(currencyNameByCountry)}</h5>
                    {
                        productDetails.discount > 0 &&
                        !isFlashProduct &&
                        <h4 className="product-price-after-discount m-0">{(productDetails.price - productDetails.discount).toFixed(2)} {t(currencyNameByCountry)}</h4>
                    }
                    {
                        productDetails.discountInOfferPeriod > 0 &&
                        isFlashProduct &&
                        <h4 className="product-price-after-discount m-0">{(productDetails.price - productDetails.discountInOfferPeriod).toFixed(2)} {t(currencyNameByCountry)}</h4>
                    }
                </div>
            </>}
        </div>
